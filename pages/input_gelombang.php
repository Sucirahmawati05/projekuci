          ...
          <form class="needs-validation" action="proses/pros_tambah_gel.php" method="post">
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <div class="invalid-feedback">
                  Valid last mominal is required.
                </div>
              </div>
